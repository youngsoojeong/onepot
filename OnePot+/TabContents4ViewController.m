...
@interface TabContents4ViewController ()

@end

@implementation TabContents4ViewController
...
- (void)viewDidLoad {
    ...
    titleData = [NSArray arrayWithObjects:  @"Creme Brelee", @"White Chocolate Donut", @"Korean Chicken Soup", @"Fried Rice", @"Thai Rice Cake", nil];
    // Do any additional setup after loading the view from its nib.
    subtitleData = [NSArray arrayWithObjects:  @"with americano", @"healthy food", @"Sometimes I drink", @"My mother's favorite", @"For my girlfriend", nil];
    
    thumbnailImage = [NSArray arrayWithObjects: @"CremeBrelee", @"WhiteChocolateDonut", @"Rice3",@"Rice2", @"Rice4", nil];
    profileImage = [NSArray arrayWithObjects:  @"pro15", @"userprofile4", @"pro17", @"pro13", @"pro12", nil];
