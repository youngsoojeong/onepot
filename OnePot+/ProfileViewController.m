...
-(IBAction)onClickPic:(id)sender{
    ...
    [self.foodNum setTitleColor:[UIColor colorWithRed:.33 green:.33 blue:.33 alpha:1] forState:UIControlStateNormal];
    //Pic Button 바꾸기
    [self.picBack setBackgroundColor:[UIColor colorWithRed:1 green:.4 blue:.4 alpha:1]];
    [self.picLabel setTextColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:1]];
    [self.picNum setTitleColor:[UIColor colorWithRed:1 green:1 blue:1 alpha:1] forState:UIControlStateNormal];
